...
//        model.addAttribute("servers", serverInfoList);
    ...
    public String serverFragments(Model model) {
        ...
        System.out.println(serverMetricDtos);
        // DTO 리스트를 모델에 추가합니다.
    ...
    public String logFragments(Model model,
        ...
        ServerHistoryDto serverHistoryDto = new ServerHistoryDto.Builder()
                ...
                .build();
        System.out.println(serverHistoryDto);
        // Convert logHistory to JSON


        model.addAttribute("serverHistory", serverHistoryDto);

        return "fragments/history :: historyContainer";
    }
}
